  ...
  async function handleSignIn() {
    ...
    try {
      ...
      if (signIn.status === "complete") {
        ...
        setError("This account needs additional verification, which isn't supported here yet.");
      }
    } finally {
      setSubmitting(false);
    }
    ...
    >
      ...
      >
        ...
        <View className="gap-4">
          ...
          <Button loading={submitting} onPress={handleSignIn}>
            Sign in
          </Button>
        </View>
